...
class InvoiceTemplates(models.Model):
    ...
    def onchange_partner_style(self):
        self.style = self.partner_id.style or self.env.user.company_id.df_style or self.env.ref(
            'professional_templates_invoice.df_style_for_all_reports')
    ...
    days_due = fields.Integer(
        'Days due',
        compute='_get_days_due'
    )
    invoice_origin_date = fields.Datetime(
        'Origin date',
        compute='_get_invoice_origin_date'
    )
