...
class TemplateSettings(models.Model):
    ...
    template_inv = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates_invoice.INVOICE\_%\_document' )]",
        required=False)
...
''',
    ...
    secuencia = fields.Boolean(
        u'Imprimir secuencia',
        default=True,
        help=
        "Marque para imprimir la secuencia en el detalle de la factura"
    )
    clave_articulo = fields.Boolean(
        u'Imprimir clave artículo',
        default=True,
        help=
        "Marque para imprimir la clave del artículo en el detalle de la factura"
    )
    clave_sat = fields.Boolean(
        u'Imprimir clave S.A.T.',
        default=True,
        help=
        "Marque para imprimir la clave S.A.T. en el detalle de la factura"
    )
    unidad_medida = fields.Boolean(
        u'Imprimir Unidad de medida',
        default=True,
        help=
        "Marque para imprimir la unidad de medida en el detalle de la factura"
    )
    clave_unidad_medida = fields.Boolean(
        u'Imprimir Clave de Unidad de medida',
        default=True,
        help=
        "Marque para imprimir la clave de la unidad de medida en el detalle de la factura"
    )
    impuestos = fields.Boolean(
        u'Imprimir Impuestos',
        default=True,
        help=
        "Marque para imprimir impuestos en el detalle de la factura"
    )
    ####################################
